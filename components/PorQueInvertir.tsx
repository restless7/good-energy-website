  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-12 left-1/2 -translate-x-1/2 w-[280px] h-[280px] z-20">
          <CircularText />
          <Image 
        ...
        {/* CAMBIO: Se envuelve la imagen de las cruces en motion.div para el efecto "breathe" */}
        <motion.div
          className="absolute top-16 right-[-50px] md:right-10 lg:right-20 z-10"
          animate={{ scale: [1, 1.05, 1], opacity: [0.3, 0.5, 0.3] }}
          transition={{ duration: 5, ease: "easeInOut", repeat: Infinity }}
        >
          <Image 
            src="/images/decor-crosses-outline.png" 
            width={450} 
            height={450} 
            alt="" 
          />
        ...
        {/* Contenido principal */}
        <div className="relative z-10 py-20 lg:py-24 flex flex-col items-center">
          <div className="w-full max-w-4xl flex flex-col items-start mt-48">
                      ...
                      <AnimatePresence>
                        {isOpen && (
                          <motion.div
                            ...
                            animate={{ opacity: 1, height: 'auto', marginTop: '0rem', paddingBottom: '1rem' }}
                            exit={{ opacity: 0, height: 0, marginTop: 0, paddingBottom: '0rem' }}
